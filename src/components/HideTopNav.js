...
const HideTopNav = ({children}) =>{  //you export the children prop in app.js
    ...
    useEffect(() => {
        ...
        else if (location.pathname === '/signup') {  //showbar is false show the loginform
            setshowbar(false)  
        }  else{
